...
function slider({container, slide, nextArrow, prevArrow, totalCounter, currentCounter, wrapper, field}){
    ...
    const slides = document.querySelectorAll(slide),
        ...
        let total = document.getElementById(totalCounter),
    ...
    next.addEventListener('click', () => {
        if (offset == replaceNum(width) * (slides.length - 1)) {
            offset = 0;
        } else {
            offset += replaceNum(width);
        }
    ...
    prev.addEventListener('click', () => {
        if (offset == 0) {
            offset = replaceNum(width) * (slides.length - 1);
        } else {
            offset -= replaceNum(width);
        }
    ...
    dots.forEach(dot =>{
        dot.addEventListener('click', (e) => {
            ...
            slideIndex = slideTo;
            offset = replaceNum(width) * (slideTo - 1);
...
window.addEventListener('DOMContentLoaded', function() {
    ...
    (0,_modules_timer__WEBPACK_IMPORTED_MODULE_6__["default"])('.timer', '2022-06-02');
});
})();
